...
import sys
sys.path.append(f'{YOUR_PATH}/scripts/')
...
# from src.Models_zh_real import *    # for real datasts like RTA100
...
Test_Dataset = 'flowers'  # options: 'sun', 'food', ...      

path = f'{YOUR_PATH}/models/train_imagenet/KTO'

res_path = f'{YOUR_PATH}/output/typo_zeroshut/KTO'
...
# Load typographic image classes , uncomment it for sun and food. 
...
# uncomment it for imagenet
# handler.load_typographic_image_classes_json(f'{YOUR_PATH}/datasets/imagenet100/typographic_attack_data_3fonts/train/typographic_image_classes.json')
