...
sys.path.append(f'/home/ak-research-01/cli/Aligning-CLIP-via-Preference-optimization/scripts/')
...
from src.Models_zh_real import *
...
method = 'dpo'  # options: 'dpo', 'ppo', 'CE' 
Test_Dataset = 'rta-100' #'imagenet' # options: 'sun', 'food'   

path = '/home/ak-research-01/cli/Aligning-CLIP-via-Preference-optimization/models/train_imagenet/IPO'

res_path = '/home/ak-research-01/cli/Aligning-CLIP-via-Preference-optimization/output/typo_zeroshut/IPO'
sys.stdout = open(f'{res_path}/zeroshut_{Test_Dataset}_logs.out', 'w')
sys.stderr = open(f'{res_path}/zeroshut_{Test_Dataset}_errors.rr', 'w')
###############################################  Dataset   ###############################################
size = 168
...
handler = DatasetHandler(obj, preprocessor, data_split_ratio=0.01, batch_size=8, pretokenize=True)

# # Load typographic image classes
# handler.load_typographic_image_classes(f"/home/ak-research-01/cli/Aligning-CLIP-via-Preference-optimization/datasets/typographic_image_classes_{Test_Dataset}.p")
...
iters_per_epoch = 10 # total_samples // batch_size
