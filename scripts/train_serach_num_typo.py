...
from src.Dataset import DatasetHandler, ExpandedDataset, create_expanded_dataloader
...
# handler.create_data("/home/ali.rasekh/ambo/final/datasets/typographic_image_classes_imagenet100.p")
...
def main(param):
    ...
    train_dataloader = create_expanded_dataloader(org_train_dataloader, param)

    print(f"Train dataset size: {len(train_dataloader.dataset)}")

    path = f'/home/ak-research-01/cli/Aligning-CLIP-via-Preference-optimization/models/num_typo_search/DPO/param_{param}'
